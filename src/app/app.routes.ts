...
export const routes: Routes = [
    ...
    { path: 'admin/accommodation-details', component: AccommodationDetailsComponent },
  { path: 'admin/feedback-details', component: FeedbackDetailsComponent },
  { path: 'admin/agent-registration', component: AgentRegistrationComponent },
  { path: 'admin/users-data', component: UsersDataComponent },
